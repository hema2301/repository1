...
public class KafkaConsumer {
	...
	/*
	 * Autowiring should be implemented. (Use
	...
	@KafkaListener(topics = "skill_data", groupId = "skill_json", containerFactory = "skillKafkaListenerFactory")
...
//	        }
	...
	@KafkaListener(topics = "loc_data", groupId = "loc_json", containerFactory = "locationKafkaListenerFactory")
...
//	/** Certification **/
	...
	@KafkaListener(topics = "cer_data", groupId = "certi_json", containerFactory = "certiKafkaListenerFactory")
...
///** Project **/
	...
	@KafkaListener(topics = "proj_data", groupId = "project_json", containerFactory = "projKafkaListenerFactory")
...
//	/** Qualification **/
	...
	@KafkaListener(topics = "acad_data", groupId = "qual_json", containerFactory = "qualKafkaListenerFactory")
